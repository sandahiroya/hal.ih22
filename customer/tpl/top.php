...
<aside>
 <h2>商品を買う</h2>
 <h3><a href="top.php?aaa=">TOPページ</a></h3>
     ...
     <tr>
        <?php for ($j=0; $j < 3; $j++) { ?>
            <?php if(isset($product_list[$p+$j])){ ?>
                 <td><img src="img/a.jpg" id="imgs"></td>
            <?php } ?>
         <?php } ?>
     </tr>
     <tr>
...
<div id="paging">
    ...
    if (isset($_GET['page_id'])  && $_GET['page_id']!= 1 ){ ?>
            <a href="./top.php?page_id=<?php echo $_GET['page_id']-1; ?>"><?php echo '前へ'; ?></a>
    <?php }else{ ?>
    ...
    <?php }
     for ($i = 1; $i <= $max_page;$i++){
        if ($i == $now){
            ...
            <a href="./top.php?page_id=<?php echo $i; ?>"><?php echo $i;?></a>
        <?php    }
     }
     if (isset($_GET['page_id']) && $_GET['page_id']  == $max_page){ ?>
         <span><?php echo '次へ'; ?></span>
    <?php }elseif($now == 1){ ?>
        <a href="./top.php?page_id=2"><?php echo '次へ'; ?></a>

    <?php }else { ?>
        <a href="./top.php?page_id=<?php echo $_GET['page_id']+1; ?>"><?php echo '次へ'; ?></a>
    <?php } ?>
    <?php } ?>
